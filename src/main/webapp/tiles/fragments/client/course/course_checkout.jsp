...
<div class="container flex mx-auto justify-center items-center">
    <form class="mt-6" method="POST" id="form-checkout">
        <input type="hidden" name="subjectid" value="${subject.id}" id="checkout-subject"/>
        ...
        <div class="grid gap-6 mb-6 lg:grid-cols-2 h-full ">
            <div class="col-span-1">
                ...
                <div class=" bg-white rounded-lg border border-gray-200 p-5">
                    <a href="#">
                        <img class="w-full h-[200px] object-cover" src="${pageContext.request.contextPath}/images/subject/${subject.image}" alt=""/>
                    </a>
                    <div class="p-2">
                        <a href="${pageContext.request.contextPath}/course/${subject.id}">
                            <h5 class="mb-2 text-xl font-medium tracking-tight text-gray-900 ">${subject.name}</h5>
                        </a>
                    </div>
