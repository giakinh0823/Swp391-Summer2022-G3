...
<script>
    var quizzesid = ${quizzes.id};
    var subjectid = ${quizzes.subjectId};
    var listDimensions = [
    <c:forEach items="${quizzes.settingQuizzes.quizzesDimensions}" var="settingDimension">
        {
            id: ${settingDimension.dimension.id},
            name: "${settingDimension.dimension.name}",
            question: ${settingDimension.numberQuestion},
        },
    </c:forEach>
    ];
</script>
                ...
                <div class="hidden p-4 rounded-lg" id="profile" role="tabpanel" aria-labelledby="profile-tab">
                    <div class="max-w-[450px] mx-auto mt-10">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="text" id="name" name="name" value="${quizzes.name}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                        ...
                        <div class="mb-6">
                            ...
                            <div class="min-h-[180px] max-h-[200px] overflow-y-auto px-2 pt-3" id="list-subject">
                                <div class="flex items-center mb-2">
                                    <input checked type="radio" value="${quizzes.subject.id}" name="subject" id="subject-${quizzes.subject.id}" onclick="selectSubject(this)"  class="w-4 h-4 text-blue-600 bg-gray-100 rounded border-gray-300 focus:ring-blue-500 focus:ring-2"/>
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" min="1" id="duration" name="duration" value="${quizzes.duration}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>

                        <div class="mb-6">
                            <label for="pass_rate" class="block mb-2 text-sm font-medium text-gray-900">Pass rate(%)</label>
                            <input type="number" min="1" id="pass_rate" name="pass_rate" value="${quizzes.pass_rate}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>


                        <div class="mb-6 mt-6">
                            <label for="description" class="block mb-2 text-sm font-medium text-gray-900">Description</label>
                            <textarea id="description" name="description" rows="4" class="block p-2.5 w-full text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:ring-blue-500 focus:border-blue-500" placeholder="Description...">${quizzes.description}</textarea>
                        </div>
                    </div>
                </div>
                <div class="hidden p-4 rounded-lg" id="dashboard" role="tabpanel" aria-labelledby="dashboard-tab">
                    <div class="max-w-[450px] mx-auto mt-10">
                        ...
                        <div class="mb-6">
                            ...
                            <input type="number" min="1" id="total_question" name="total_question" value="${quizzes.settingQuizzes.totalQuestion}" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5">
                        </div>
                        <div class="mb-6">
                        ...
                        <div class="mb-6" id="selected-dimension">
                            <c:forEach items="${quizzes.settingQuizzes.quizzesDimensions}" var="settingDimension">
                                <div class="flex mb-3">
                                    <input type="hidden" min="1" name="dimension" value="${settingDimension.dimension.id}" class="ml-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
                                    <input type="text" disabled value="${settingDimension.dimension.name}" class="w-full bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
                                    <input type="number" min="1" name="number_question" value="${settingDimension.numberQuestion}" class="ml-2 bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block p-2.5">
                                    <button type="button" class="ml-2" onclick="deleteDimension(${settingDimension.dimension.id})">
